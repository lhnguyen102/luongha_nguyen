  ...
  return (
    <section className='relative w-full h-[500px] mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[60px] sm:top-[120px] max-w-7xl mx-auto flex flex-col sm:flex-row items-start gap-5`}>
        <img src={myphoto} alt="Personal" className="w-[140px] h-[140px] md:w-[150px] md:h-[150px] lg:w-[200px] lg:h-[200px] ml-40 mt-4 mb-0 lg:ml-auto rounded-full" />
        ...
        <div className={`${styles.heroHeadText} text-white`}>
          <h1 className='lg:h-[140px] lg:text-[70px]'>Hi, I'm <span className='text-[#008bff]'> Luong-Ha</span></h1>
